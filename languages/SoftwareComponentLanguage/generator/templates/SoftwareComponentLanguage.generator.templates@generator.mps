          ...
          <node concept="3JmXsc" id="pZehJpTRHN" role="2P8S$">
            <node concept="3clFbS" id="pZehJpTRHO" role="2VODD2">
              <node concept="3clFbF" id="pZehJpTRIB" role="3cqZAp">
                <node concept="2OqwBi" id="pZehJpTUgk" role="3clFbG">
                  <node concept="1PxgMI" id="pZehJpTTNA" role="2Oq$k0">
                    <property role="1BlNFB" value="true" />
                    <node concept="chp4Y" id="pZehJpTTWC" role="3oSUPX">
                      <ref role="cht4Q" to="tj5x:2Cg1yFhs69O" resolve="SoftwareComponent" />
                    </node>
                    <node concept="30H73N" id="pZehJpTRIA" role="1m5AlR" />
                  </node>
                  <node concept="3Tsc0h" id="pZehJpTUxJ" role="2OqNvi">
                    <ref role="3TtcxE" to="tj5x:zd_6PSizb9" resolve="providedInterfaceImplementations" />
                  </node>
                </node>
              </node>
            </node>
        ...
        <node concept="17Uvod" id="6KCmRAYoltO" role="lGtFl">
          ...
          <node concept="3zFVjK" id="6KCmRAYoltP" role="3zH0cK">
            <node concept="3clFbS" id="6KCmRAYoltQ" role="2VODD2">
              <node concept="3clFbF" id="6KCmRAYolIQ" role="3cqZAp">
                <node concept="2OqwBi" id="6KCmRAYomCW" role="3clFbG">
                  <node concept="2OqwBi" id="6KCmRAYombA" role="2Oq$k0">
                    <node concept="30H73N" id="6KCmRAYolIP" role="2Oq$k0" />
                    <node concept="3TrEf2" id="6KCmRAYommD" role="2OqNvi">
                      <ref role="3Tt5mk" to="tj5x:2Cg1yFhu3zA" resolve="componentRef" />
                    </node>
                  </node>
                  <node concept="3TrcHB" id="6KCmRAYonbb" role="2OqNvi">
                    <ref role="3TsBF5" to="tpck:h0TrG11" resolve="name" />
                  </node>
                </node>
              </node>
